...
func (l *LuaFormater) formatRows() {
	...
	l.appendData("-- Auto generated by excelparser. DO NOT EDIT!\n")
	l.appendEOL()
	l.appendData(l.formatLuaComment(l.mode))
	l.appendEOL()

	// data
	if l.Vertical {
		l.appendData("local t =")
...
// json
func (l *LuaFormater) formatJsonKey(key any) string {
	var keystr string
	switch key.(type) {
	case int, uint:
...
func (l *LuaFormater) formatJsonValue(field *Field, t *Type, obj any, depth int) {
	var vt *Type
	if t != nil {
		vt = t.Vtype
	}
